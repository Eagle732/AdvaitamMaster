...
public class Quest extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        myPageerAdapter.addFragment(new QuestSubfragmentDetails(),"Details");
        myPageerAdapter.addFragment(new QuestSubfragment1(),"My Profile");
        myPageerAdapter.addFragment(new QuestSubfragment2(),"Leaderboards");
