...
public class Events extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        myPageerAdapter.addFragment(new EventsAdvaitam(),"Advaitam");
        myPageerAdapter.addFragment(new EventsList(),"Events List");
        myPageerAdapter.addFragment(new EventsOrganisers(),"Events Organisers");
